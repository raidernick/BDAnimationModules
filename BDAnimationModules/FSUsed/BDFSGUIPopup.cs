...
public class BDFSGUIPopup
{
    ...
    public BDFSGUIPopup(Part part, string module, int ID, int Windowlayer, Rect windowDimensions, string windowName, PopupElement defaultElement)    
    {
    ...
    public BDFSGUIPopup(Part part, string module, int ID, int Windowlayer, Rect windowDimensions, string windowName)
    {
        parentPart = part;
        moduleName = module;
        moduleID = ID;
    ...
    public BDFSGUIPopup(int Windowlayer, Rect windowDimensions, string windowName)
    {
        GUIlayer = Windowlayer;
        windowRect = windowDimensions;
        windowTitle = windowName;

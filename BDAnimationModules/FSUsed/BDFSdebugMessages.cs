...
namespace BDAnimationModules.info
{
    public class BDFSdebugMessages : MonoBehaviour
    {
        ...
        public BDFSdebugMessages()
        {
        }

        public BDFSdebugMessages(bool _debugMode, string _moduleName)
        {
        ...
        public BDFSdebugMessages(bool _debugMode, OutputMode _outputMode, float _postToScreenDuration)
        {
            debugMode = _debugMode;
